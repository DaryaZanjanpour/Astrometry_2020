# -*- coding: utf-8 -*-
"""
Created on Wed Dec  4 14:58:19 2019
...
#FLAT
d1 = Path('Proserpina/26Proserpina/20120122/Day 3/FLAT')
day1 = os.listdir(d1)
...
#Dark
d1 = Path('Proserpina/26Proserpina/20120122/Day 3/DARK')
day1 = os.listdir(d1)
headerd1 = fits.open(d1/ day1[0])
#getting data and median for the Proserpina data
for i in range(0,int(len(day1))):
...
#Bias
d1 = Path('Proserpina/26Proserpina/20120122/Day 3/BIAS')
day1 = os.listdir(d1)
headerd1 = fits.open(d1/ day1[0])
#getting data and median for the Proserpina data
for i in range(0,int(len(day1))):
...
#DATA
d1 = Path('Proserpina/26Proserpina/20120122/Day 3/DATA')
day1 = os.listdir(d1)
headerd1 = fits.open(d1/ day1[0])
#getting data and median for the Proserpina data
for i in range(0,int(len(day1))):
...
def finalcenteroid():
    ...
    finalcenteroy= ([])
    c= 0
    for x in range (60 , 1300): #(24,2024)
                ...
                if (data[y-1][x]<Border):
                    if (data[y][x-1]<Border):
                        ...
                        if (len(newbornfence)>0):
                            ...
                            c= c+0
    for x in range (1400 , 2024): #(24,2024)
        for y in range(24 , 2024): #(24,2024)
            if (data[y][x]>Border):
                if (data[y-1][x]<Border):
                    if (data[y][x-1]<Border):
