...
#FLAT
d1 = Path('Proserpina/26Proserpina/20120125/Day 4/FLAT')
day1 = os.listdir(d1)
...
#Dark
d1 = Path('Proserpina/26Proserpina/20120125/Day 4/DARK')
day1 = os.listdir(d1)
headerd1 = fits.open(d1/ day1[0])
#getting data and median for the Proserpina data
for i in range(0,int(len(day1))):
...
#Bias
d1 = Path('Proserpina/26Proserpina/20120125/Day 4/BIAS')
day1 = os.listdir(d1)
headerd1 = fits.open(d1/ day1[0])
#getting data and median for the Proserpina data
for i in range(0,int(len(day1))):
...
#DATA
d1 = Path('Proserpina/26Proserpina/20120125/Day 4/DATA')
day1 = os.listdir(d1)
headerd1 = fits.open(d1/ day1[0])
#getting data and median for the Proserpina data
for i in range(0,int(len(day1))):
